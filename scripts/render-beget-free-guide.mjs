...
const profile=mkdtempSync('/tmp/beget-free-pdf-');
...
try {
  ...
  await send('Page.navigate',{url:pathToFileURL(resolve('docs/portfolio-beget-free-guide.html')).href});
  ...
  writeFileSync('artifacts/archive/instructions/portfolio-beget-free-guide.pdf',Buffer.from(pdf.data,'base64'));
  console.log('PDF: artifacts/archive/instructions/portfolio-beget-free-guide.pdf');
