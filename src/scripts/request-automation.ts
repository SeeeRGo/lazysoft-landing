...
function render() {
  ...
  const labels = {
    queued: "Заявка в очереди. Здесь появится демо.", generating: "Готовим демо по вашей идее.",
    review: "Демо готово. Посмотрите результат выше.", revision_queued: "Правки приняты. Обновлённый результат появится здесь.",
    revising: "Вносим ваши правки в демо.", complete: "Результат готов. Выберите следующий шаг.",
